...
from PyQt5.QtWidgets import QMainWindow, QApplication, QShortcut, QAction, QSizePolicy
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        call_board_ini()  # read modules info
    ...
    def time_msg(self, out):
        ...
        self.labeloftime.setText(
            _translate(
                "MainWindow",
                "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">%s</span></p>"
                "<p align=\"center\"><span style=\" font-size:24pt;\">%s</span></p>"
                "<p align=\"center\"><span style=\" font-size:16pt;\">%s</span></p>"
    ...
    def set_hotkeys(self):  # горячие клавиши для завершения и сворачивания
        # свернуть окно по CTRL+H
        self.minact = QAction(self)
        self.minact.setShortcut(QKeySequence("CTRL+H"))
        ...
        # Exit CTRL+Q
        self.actq = QShortcut(QKeySequence('CTRL+Q'), self)
        self.actq.activated.connect(self.All_is_Clear)
        # Exit CTRL+Й
        self.actqr = QShortcut(QKeySequence('CTRL+Й'), self)
        self.actqr.activated.connect(self.All_is_Clear)
